...
var Index = function Index(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    ...
    if (!router.query.locale) {
      setLocaleFn(_defaults_Languages__WEBPACK_IMPORTED_MODULE_14__["default"].includes(window.navigator.language) ? window.navigator.language : _defaults_Languages__WEBPACK_IMPORTED_MODULE_14__["DEFAULT_LANGUAGE"]);

      if (_defaults_Languages__WEBPACK_IMPORTED_MODULE_14__["default"].includes(window.navigator.language)) {
        setLocaleFn(window.navigator.language);
      } else {
        setLocaleFn(_defaults_Languages__WEBPACK_IMPORTED_MODULE_14__["DEFAULT_LANGUAGE"]);
      }
    }
...
//# sourceMappingURL=index.js.5f76df58e73751026af2.hot-update.js.map