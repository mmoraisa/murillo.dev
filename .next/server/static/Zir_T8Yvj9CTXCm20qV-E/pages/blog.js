...
// CONCATENATED MODULE: ./components/posts/BlogPost/DoubleBlogPost.js
...
var DoubleBlogPost_DoubleBlogPost = function DoubleBlogPost(_ref) {
  var even = _ref.even,
      post = _ref.post;
  ...
  return external_react_default.a.createElement(Language["a" /* Consumer */], null, function (_ref2) {
    ...
    }, "18/05/2019"), external_react_default.a.createElement("span", {
      className: "jsx-1039251275" + " " + "post__content__title"
    }, post.fields.title), external_react_default.a.createElement("div", {
      className: "jsx-1039251275" + " " + "post__content__separator"
    }), external_react_default.a.createElement("span", {
      className: "jsx-1039251275" + " " + "post__content__description"
    }, post.fields.description)), post.fields.heroImage.fields.file && post.fields.heroImage.fields.file.url && post.fields.heroImage.fields.file.url.length && external_react_default.a.createElement("div", {
      style: {
...
/* harmony default export */ var BlogPost_DoubleBlogPost = (DoubleBlogPost_DoubleBlogPost);
// CONCATENATED MODULE: ./components/posts/BlogPost/TripleBlogPost.js
...
var TripleBlogPost_TripleBlogPost = function TripleBlogPost(_ref) {
  var post = _ref.post;
  Object(external_react_["useEffect"])(function () {
    external_aos_default.a.init();
  }, []);
  return external_react_default.a.createElement(Language["a" /* Consumer */], null, function (_ref2) {
    ...
    }, post.fields.description)), external_react_default.a.createElement("div", {
      style: {
        background: "url(".concat(post.fields.heroImage.fields.file.url, "?w=300&h=300&fit=thumb)"),
        backgroundSize: 'cover'
      },
    ...
    }), post.fields.video && post.fields.video.length && external_react_default.a.createElement("iframe", {
...
/* harmony default export */ var BlogPost_TripleBlogPost = (TripleBlogPost_TripleBlogPost);
// CONCATENATED MODULE: ./components/posts/BlogPost/index.js




var BlogPost_BlogPost = function BlogPost(_ref) {
  var index = _ref.index,
      post = _ref.post;
  return index % 2 !== 0 ? external_react_default.a.createElement(BlogPost_DoubleBlogPost, {
    even: true,
    post: post
  }) : (index + 1) % 3 === 0 ? external_react_default.a.createElement(BlogPost_TripleBlogPost, {
    post: post
  }) : external_react_default.a.createElement(BlogPost_DoubleBlogPost, {
    even: false,
    post: post
  });
};

/* harmony default export */ var posts_BlogPost = (BlogPost_BlogPost);
...
var blog_Blog = function Blog(_ref) {
  ...
  Object(external_react_["useEffect"])(function () {
    ...
    client.getEntries({
      ...
      order: '-sys.createdAt',
      locale: router.query.locale || Languages["a" /* DEFAULT_LANGUAGE */]
    }).then(function (response) {
      setPosts(response.items);
    });
    document.documentElement.setAttribute('lang', router.query.locale || Languages["a" /* DEFAULT_LANGUAGE */]);
  }, []);
  return external_react_default.a.createElement(main["a" /* default */], null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", {
  ...
  }, "Murillo de Morais - Blog"), external_react_default.a.createElement("meta", {
    name: "description",
    ...
    return external_react_default.a.createElement(posts_BlogPost, {
      key: i,
      index: i,
      post: post
    });
...
/* harmony default export */ var blog = __webpack_exports__["default"] = (Object(router_["withRouter"])(blog_Blog));
