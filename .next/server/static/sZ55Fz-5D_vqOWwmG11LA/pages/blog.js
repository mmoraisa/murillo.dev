...
var TripleBlogPost_TripleBlogPost = function TripleBlogPost(_ref) {
  ...
  return external_react_default.a.createElement(Language["a" /* Consumer */], null, function (_ref2) {
    ...
    return external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement(link_default.a, {
      ...
      "data-aos": "fade-up",
      className: "jsx-702716746" + " " + "post"
    }, external_react_default.a.createElement("div", {
      className: "jsx-702716746" + " " + "post__content"
    }, external_react_default.a.createElement("span", {
      className: "jsx-702716746" + " " + "post__content__date"
    }, "18/05/2019"), external_react_default.a.createElement("span", {
      className: "jsx-702716746" + " " + "post__content__title"
    }, post.fields.title), external_react_default.a.createElement("div", {
      className: "jsx-702716746" + " " + "post__content__separator"
    }), external_react_default.a.createElement("span", {
      className: "jsx-702716746" + " " + "post__content__description"
    }, post.fields.description)), external_react_default.a.createElement("div", {
      style: {
        background: "url(".concat(post.fields.heroImage.fields.file.url, "?w=300&h=300&fit=thumb)"),
        backgroundSize: 'cover'
      },
      className: "jsx-702716746" + " " + "post__image"
    }), external_react_default.a.createElement("div", {
      className: "jsx-702716746" + " " + "post__video"
    }, external_react_default.a.createElement("div", {
      className: "jsx-702716746" + " " + "post__video__backdrop"
      ...
      className: "jsx-702716746" + " " + "post__video__content"
    })))), external_react_default.a.createElement(style_default.a, {
      id: "702716746"
    }, [".post.jsx-702716746{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;background:white;-webkit-transform:scale(1);-ms-transform:scale(1);transform:scale(1);-webkit-transition:.1s all ease;transition:.1s all ease;cursor:pointer;}", ".post.jsx-702716746:hover{-webkit-transform:scale(1.05);-ms-transform:scale(1.05);transform:scale(1.05);z-index:1;box-shadow:3px 3px 10px rgba(0,0,0,.15);}", ".post.jsx-702716746>div.jsx-702716746{width:240px;min-height:240px;height:auto;padding:30px;}", ".post__content.jsx-702716746{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;background:white;}", ".post__content__date.jsx-702716746{font-family:medium-content-serif-font,Georgia,Cambria,\"Times New Roman\",Times,serif;color:#afafaf;font-size:14px;}", ".post__content__title.jsx-702716746{font-family:stolzl,sans-serif;font-weight:600;font-size:26px;margin:10px 0 0 0;text-transform:uppercase;}", ".post__content__separator.jsx-702716746{margin:30px 0;border:1px solid #e4e4e4;width:50px;}", ".post__content__description.jsx-702716746{color:rgba(0,0,0,.84);font-family:medium-content-serif-font,Georgia,Cambria,\"Times New Roman\",Times,serif;font-weight:100;font-size:16px;line-height:22px;text-rendering:optimizeLegibility;-webkit-font-smoothing:antialiased;word-break:break-word;}", ".post__image.jsx-702716746{background:#9ec6f1;}", ".post__video.jsx-702716746{width:300px;padding:0 !important;}", ".post__video__backdrop.jsx-702716746{position:absolute;width:300px;height:100%;background:#005f8854;pointer-events:none;}", ".post__video__content.jsx-702716746{width:calc(100% + 60px);height:100%;}", "@media screen and (max-width:970px){.post.jsx-702716746{width:calc(100% - 30px);margin:10px 15px;border-radius:10px;box-shadow:5px 5px 20px rgba(0,0,0,.3);overflow:hidden;}.post.jsx-702716746>div.jsx-702716746{padding:10px;width:initial;height:initial;}.post.--is-even.jsx-702716746{-webkit-align-self:initial;-ms-flex-item-align:initial;align-self:initial;}.post__content.jsx-702716746{-webkit-flex:1;-ms-flex:1;flex:1;}.post__image.jsx-702716746{width:20% !important;-webkit-order:-1;-ms-flex-order:-1;order:-1;}.post__content__separator.jsx-702716746{margin:10px 0;}.post__content__title.jsx-702716746{font-size:22px;}.post__video.jsx-702716746{display:none;}}"]));
  });
};
